...
def model_comparison_WAIC(models, path, file_id, MODEL_NAME_MAP, should_plot=True, export=True):
...
def model_comparison_LOO(models, path, file_id, MODEL_NAME_MAP, should_plot=True, export=True):
